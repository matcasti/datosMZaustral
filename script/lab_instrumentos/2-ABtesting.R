...
## script: 2-ABtesting.R
## función: probar diferentes modelos modelos de clusterización variando únicamente en la
## selección de region == 1 o region %in% c(1,0)
...
# Solo region == 1 ----------------------------------------------------------------------------
  ...
  source("script/lab_instrumentos/3-clustering.R")
